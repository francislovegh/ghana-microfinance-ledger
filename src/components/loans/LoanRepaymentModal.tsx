    ...
    try {
      ...
      const { error: loanError } = await supabase
        ...
        .update({
          ...
          status: isFullyPaid ? "fully_paid" as LoanStatus : "active" as LoanStatus,
      ...
      // Generate transaction number to satisfy database requirements
      ...
      // Create transaction record with the proper transaction number
      const { error: transactionError } = await supabase
        ...
        .insert({
          ...
          amount: amount,
          transaction_type: "loan_repayment" as TransactionType,
